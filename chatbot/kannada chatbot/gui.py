...
# Menu bar
    ...
    def about(self):
        tkinter.messagebox.showinfo("PyBOT Developers","1.chaitanya\n2.sowmya\n3.harika\n4.suman")
    ...
    def send_message_insert(self, message):
        ...
        t2=translator.translate(user_input,lang_src='kn',lang_tgt='en')
        ob=chat(t2)
        pr="PyBot : " + ob + "\n"
       # print(type(pr))
        t=translator.translate(pr,lang_src='en',lang_tgt='kn')
        t1=translator.translate(pr,lang_src='en',lang_tgt='te')
        self.text_box.configure(state=NORMAL)
