...
# Menu bar
    ...
    def playResponce(self,responce):
        ...
        #t=translator.translate(responce,src='en',dest='telugu')
        x.say(responce)
        x.runAndWait()
    ...
    def about(self):
        tkinter.messagebox.showinfo("PyBOT Developers","1.T.chaitanya\n2.suman\n3.harika\n4.sowmya")
    ...
    def send_message_insert(self, message):
        ...
        t2=translator.translate(user_input,lang_src='te',lang_tgt='en')
        ob=chat(t2)
        pr="ChatBot : " + ob + "\n"
       # print(type(pr))
        t=translator.translate(pr,lang_src='en',lang_tgt='te')
        t1=translator.translate(pr,lang_src='en',lang_tgt='hi')
        self.text_box.configure(state=NORMAL)
        self.text_box.insert(END,pr)
        self.text_box.insert(END,t)
        self.text_box.insert(END,'\n')
        self.text_box.insert(END,t1)
       # print(t)
        self.text_box.configure(state=DISABLED)
        self.text_box.see(END)
